package ru.nenology.netologyvoiceassistant
...
class MainActivity : AppCompatActivity() {
    ...
    fun initViews() {
        ...
        requestInput.setOnEditorActionListener { textView, actionId, keyEvent ->
